...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Granblue Fantasy Relink Endless Ragnarok Wiki",
    description: "Read the Terms of Service for Granblue Fantasy Relink Endless Ragnarok Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Granblue Fantasy Relink Endless Ragnarok Wiki",
      description: "Terms and conditions for using Granblue Fantasy Relink Endless Ragnarok Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Granblue Fantasy Relink Endless Ragnarok Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Granblue Fantasy Relink Endless Ragnarok Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Granblue Fantasy Relink Endless Ragnarok Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Granblue Fantasy Relink Endless Ragnarok Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to "Granblue Fantasy: Relink" (available on PlayStation 5, PlayStation 4, and Steam). Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and survival strategies</li>
              <li>Character and build guides</li>
              <li>Weapon, sigil, and material references</li>
              <li>Quest walkthroughs and boss strategies</li>
              <li>Achievement walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Granblue Fantasy Relink Endless Ragnarok Wiki is NOT affiliated with, endorsed by, or associated with
              Valve Corporation (Steam) or Cygames (the developer of Granblue Fantasy: Relink). We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Granblue Fantasy Relink Endless Ragnarok Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (Steam) and/or Cygames (the developer of Granblue Fantasy: Relink). We use such
            ...
            <ul>
              ...
              <li><strong>Game Availability:</strong> Platform availability, demos, and game updates on PlayStation and Steam may change without notice. We are not responsible for demo access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, GRANBLUE FANTASY RELINK ENDLESS RAGNAROK WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Granblue Fantasy Relink Endless Ragnarok Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@granbluefantasyrelinkendlessragnarok.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@granbluefantasyrelinkendlessragnarok.wiki</a>
            </p>
            <p>
